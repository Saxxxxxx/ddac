...
@admin.register(FoodSharingListing)
class FoodSharingListingAdmin(admin.ModelAdmin):
    
    list_display = ('title', 'description','price','get_state_name','get_country_name','get_category_name','get_status','creator')
    fieldsets = (
        (None, {'fields': ('title', 'description')}),
        (_('Listing Information'), {'fields': ('price', 'category_id','status','images','image_tag')}),
        (_('Location'), {'fields': ('street_address', 'postal_code','state_id','country_id')}),
        (_('Time'), {'fields': ('held_date', 'expiration_date')}),
        (_('Creator'), {
            'fields': ('creator', 'user'),
        }),
    )
...
@admin.register(FoodSharingCategory)
class FoodSharingCategoryAdmin(admin.ModelAdmin):
    pass

@admin.register(FoodSharingListingImage)
...
# admin.site.register(FoodSharingListing,FoodSharingListingAdmin)
# admin.site.register(FoodSharingListingImage, ImageAdmin)
